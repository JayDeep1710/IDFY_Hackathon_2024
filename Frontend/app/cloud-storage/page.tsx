...
import { setFullResponse } from "../features/responseSlice";
...
let config = {
  ...
  url: `http://localhost:8000/aws?bucket_name=${bucketName}&aws_access_key_id=${accessId}&aws_secret_access_key=${accessKey}&aws_region=${awsRegion}`,
  headers: { 
  ...
  <div className="flex justify-center items-center absolute inset-0 mt-40">
    <div className="text-center">
      <div className="spinner mx-auto"></div>
        ...
        {data===null && !isLoading && <div className="flex flex-col items-center justify-center h-full">
          <div
            className="p-10"
        ...
        {data!==null && !isLoading && <Result risk_score={data['score']} images={data['images']} code={data['code']} texts={data['texts']}/>}
      </main>
